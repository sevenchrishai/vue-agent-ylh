    ...
    <el-container>
      <el-header>
        ...
        <div class="bottom">
          ...
          <div class="r">
            <el-button type="primary large">未结算金额</el-button>
          </div>
        </div>
      </el-header>
      ...
      <el-footer>
          <el-tag type="info">关于我们</el-tag>
          <el-tag type="info">联系我们</el-tag>
          <el-tag type="info">隐私政策</el-tag>
          <el-tag type="info">服务条款</el-tag>
      </el-footer>
    </el-container>
