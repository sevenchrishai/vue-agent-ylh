  ...
  <div class="container">
        ...
        <div class="wheel-bg" :style="{transform: rotate_angle, transition: rotate_transition}">
          ...
          <div class="prize-list">
            <div class="prize-item" v-for="(item,index) in prize_list" :key="index">
              <div class="prize-pic"><img :src="item.icon" alt=""></div>
    ...
    <div class="toast" v-show="toast_control">
      <div class="toast-container">
        <img class="toast-pic" :src="toast_pic" >
  ...
  export default {
    ...
    data() {
      return {
        ...
        toast_control: false, // 控制抽奖结果弹出
        hasPrize: false,  // 是否中奖
        start_rotating_degree: 0, // 转盘初始旋转角度
        rotate_angle: 0, // 转盘将要旋转的角度
        start_rotating_degree_pointer: 0, // 指针初始旋转角度
        rotate_angle_pointer: 0, // 指针将要旋转的度数
        rotate_transition: "transform 6s ease-in-out", // 转盘初始化选中的过渡属性控制
        rotate_transition_pointer: "transform 12s ease-in-out", // 指针初始化指针过渡属性控制
    ...
    methods: {
      ...
      rotating(){
        ...
        var during_time = 5; // 持续时间，默认为1s
        var random = Math.floor(Math.random() * 7); // 0-6 的随机数
        ...
        if (type == 0) {
          ...
          console.log(`index = ${result_index}`);
