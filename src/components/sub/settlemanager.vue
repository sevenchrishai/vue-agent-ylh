<template>
  <section class="settle-manager">
    <el-form style="margin:10px 0;">
      <el-row>
        <el-col :span="8" style="">
          <el-form-item label="文件名:">
            <el-input placeholder="请输入文件名(默认为excel-list)" v-model="filename" style="width:180px;"
        ...
        <el-col :span="8" style="">
          <el-form-item style="margin-left: 10px;">
            <el-button type="primary" :loading="downloadLoading" v-on:click="handleDownload" icon="document">
              导出Excel
            </el-button>
          </el-form-item>
        </el-col>
    ...
    <!--工具条-->
    <el-form ref="form" :model="form" @submit.prevent="onSubmit" style="margin:10px;" v-if="false">
    ...
    methods: {
      ...
      handleDownload() {
        ...
        import('@/vendor/Export2Excel').then(excel => {
          const tHeader = ['Id', 'Title', 'Content', 'Time'];
          const filterVal = ['strMaintainId', 'strTitle', 'strContent', 'createTime'];
