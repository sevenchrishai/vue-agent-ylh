<template>
  <section class="trade-manager">
    ...
    <div class="panel">
      ...
      <div class="panel-body">
        ...
        <el-col :span="24" class="pag">
          <el-button type="danger" @click="batchRemove" :disabled="this.sels.length===0" class="fl" style="float:left;">批量删除</el-button>
          <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
                         :current-page.sync="listQuery.curPage" :page-sizes="[10,20,30, 50]"
                         :page-size="listQuery.pageSize"
                         layout="total, sizes, prev, pager, next, jumper" :total="total" class="fr" style="float: right;">
          </el-pagination>
        </el-col>
      </div>
    </div>
    ...
    <!--编辑界面-->
    <el-dialog title="编辑维护项" :visible.sync="editFormVisible">
